        ...
        class QuadraticHashTable
        {
          public:
            ...
            void * find( const HashedObj & x ) const;

            void makeEmpty( );
            void insert( const HashedObj & x, void *userData );
          ...
          private:
            struct HashEntry
            {
                ...
                HashEntry( const HashedObj & e = HashedObj( ), EntryType i = EMPTY, void *u = NULL )
                  : element( e ), info( i ), userData(u) { }
            };
